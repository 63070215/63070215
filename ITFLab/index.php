						...
						<div class="table-responsive">
							...
							<table class="table table-borderless table-hover">
								...
								<tbody>
									...
									?>
									<tr>
										<td><a href="delete.php?ID=<?php echo $Result['ID'];?>" class="btn btn-sm btn-danger mb-2 mb-md-0">ลบ</a> <a href="edit.php?ID=<?php echo $Result['ID'];?>" class="btn btn-success mb-2 mb-md-0">แก้ไข</a></td>
